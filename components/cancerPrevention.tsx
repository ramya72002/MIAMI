...
export default function CancerPrevention() {
  return (
    <section className="relative">
      <div className="container mx-auto mt-12 px-4 flex flex-wrap items-center" style={{backgroundColor:"#FF8C00"}}>
        <div className="content">
        <button className="container flex justify-center items-center button-red mb-8">Skin Cancer Prevention</button>
          <h2 className="text-green-900 text-2xl font-bold mb-4">Sun Safety Practices</h2>

          <div className="sun-safety border-green-900 border-2 rounded-lg p-4 mb-6">
            <h3 className="text-green-900 text-lg font-bold mb-2">Seek Shade</h3>
          ...
          <div className="sunscreen border-green-900 border-2 rounded-lg p-4 mb-6">
            <h3 className="text-green-900 text-lg font-bold mb-2">Wear Sunscreen</h3>
            <ul className="text-black list-disc pl-6">
          ...
          <div className="clothing border-green-900 border-2 rounded-lg p-4 mb-6">
            <h3 className="text-green-900 text-lg font-bold mb-2">Wear Protective Clothing</h3>
            <ul className="text-black list-disc pl-6">
          ...
          <div className="uv-index border-green-900 border-2 rounded-lg p-4 mb-6">
            <h3 className="text-green-900 text-lg font-bold mb-2">Check the UV Index</h3>
            <ul className="text-black list-disc pl-6">
          ...
          <p className="text-black mb-6">The UV Index predicts the ultraviolet radiation levels on a 1-11+ scale, helping people determine appropriate sun-protective behaviors. Find your area’s UV index rating through the National Weather Service to determine the necessary precautions.</p>
